...
[Build 3's successful run](https://github.com/jonluca/amaze/actions/runs/34070976937) archived source commit `2489ab30ce86dc651961413fa667bb6dc6c3a4f0`. The final IPA passed signature, entitlement, ZIP integrity, privacy-manifest, and app/dSYM UUID checks; no test artifacts were packaged, and the production SDK metadata remained unchanged. Its verified SHA-256 is recorded in [VALIDATION.md](VALIDATION.md).
