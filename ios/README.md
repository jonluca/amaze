...
The subsequent [missed-swipe fix](SWIPE_RELIABILITY.md) and [smoother rendering pass](SMOOTHNESS.md) are local and are not in TestFlight build 4. They resolve quick diagonal flicks and overlapping contacts, enable ProMotion up to 120 FPS, soften ball stops without extending slides, and reuse prepared paint effects.
