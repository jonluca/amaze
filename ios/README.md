...
**1.0.0 (12)** is available in the private **Owner Testing** TestFlight group and **Waiting for Review** with all four in-app purchases, verified **September 9, 2026 at 11:26 AM Pacific**. It adds 1,000 unique Classic boards with bundled exact Perfect counts, asynchronous optimal hints from any current paint state, and continuous drag turns and reversals. The unreleased catalog has no historical-board preservation layer. Release remains manual after approval. See [release and submission verification](VALIDATION.md#current-testflight-and-app-store-review--build-12).
